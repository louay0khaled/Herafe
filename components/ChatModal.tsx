      ...
      >
        ...
        {conversation.messages.map(msg => (
          <div key={msg.id} className={`flex items-end gap-2 ${msg.sender === currentUserType ? 'justify-end' : 'justify-start'}`}>
            ...
            <div className={`py-2 px-3 rounded-2xl max-w-[75%] shadow-sm ${msg.sender === currentUserType ? 'bg-sky-500 text-white rounded-br-lg' : 'bg-white text-gray-800 rounded-bl-lg'}`}>
